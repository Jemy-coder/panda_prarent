...
public class MybatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/test?serverTimezone=UTC");//8.0
...
//        strategy.setSuperControllerClass("org.jn.rd.basics.controller.BaseController");//继承的Controller
